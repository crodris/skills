...
The light lane skips the code reviewer's Standards and Spec subagents; the security lane dispatches a third `general-purpose` subagent beside them, on the same diff, briefed to review it for security alone.
